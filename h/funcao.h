...
float x=-2000,y=-2000,velx=0,vely=0,ace=0.10,sex=0,xgym[30],ygym[30];//controla variavels do cenario
bool p=false,pp=false,comeca=false,parou=false,ga=false,pro=false,lojaopen=false;
bool tempo=false;
int tecla_ante[KEY_MAX],frame=0,stopf=0,sel,sel2,sel3,vx=2,vy=2,ht=1,es,tam=0,tamf=1,ii=0,round=1,ou=0,qtdn=30,coni=0,conp=0;//atributos do cenario
...
int myhp=5,tempopro=3000,cuv=3,rale=0,preco1=0,preco2=0,preco3=0,preco4=0,roupa=0;//atributos do maleman
void atualiza_tecla();
